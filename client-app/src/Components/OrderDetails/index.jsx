    ...
    <>
      ...
      <div className='accnt-details mx-5'>
        {orderDetails && !orderDetails._id ? (
          <p className='alert alert-danger'> Details for the Given Order are Not Available</p>
        ) : (
          <>
            ...
            <div className='border box py-2 px-3'>
              ...
              <Label fieldClass='text-black' fieldData='Name' valueClass='text-black' valueData={orderDetails.name} />
              <Label
              ...
              />
              <Label fieldClass='text-black' fieldData='City' valueClass='text-black' valueData={orderDetails.city} />
              <Label
                fieldClass='text-black'
                fieldData='Country'
                valueClass='text-black'
              ...
              />
              <Label fieldClass='text-black' fieldData='Email' valueClass='text-black' valueData={orderDetails.email} />
            </div>
          </>
        )}
      </div>
