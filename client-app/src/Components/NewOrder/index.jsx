...
export default function () {
    ...
    const [verficationStatus, setVerificationStatus] = useState(false);
    ...
    useEffect(() => {
        setIsLoading(true);
        const email = JSON.parse(window.localStorage.getItem('authData')).email;
                    ...
                    {' to view your Order Details'}
                        ...
                        <div className='d-flex justify-content-end'>
                            <button
                                ...
                                onClick={() => {
                                    if (checkValidations() && verficationStatus) {
                                        submitNewOrder();
                                    }
                                }}>
                                Submit
